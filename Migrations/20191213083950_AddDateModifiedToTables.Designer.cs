...
// 並且這三個表格的資料透過 Web API 更新時，都要自動更新該欄位為更新當下的時間 (新增資料庫移轉紀錄)

namespace WebApplication1.Migrations
{
    [DbContext(typeof(ContosouniversityContext))]
    [Migration("20191213083950_AddDateModifiedToTables")]
    partial class AddDateModifiedToTables
    {
            ...
            modelBuilder.Entity("WebApplication1.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("WebApplication1.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Person", "Student")
                        .WithMany("Enrollment")
